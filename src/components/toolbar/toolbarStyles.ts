...
export const toolbarStyles = {
  ...
  statusIndicator: baseStyles.statusIndicator,
  statusSvg: baseStyles.statusSvg,
  statusIconReady: baseStyles.statusIconReady,
  statusIconError: baseStyles.statusIconError,
